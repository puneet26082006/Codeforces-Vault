...
void solve()
{
    ...
    //         cout << 0 << endl;
    //     } else if(even == 1) {
    //         // We need 1 operation to make another even, UNLESS ans is already 0
    //         // (but ans=0 returns early, so we just check against ans)
    //         cout << min(ans, 1) << endl;
    //     } else {
    //         // We need 2 ops to make two evens, unless a single element can do it in 1
    //         cout << min(ans, 2) << endl;
    //     }
    // } else {
    //     cout << ans << endl;
