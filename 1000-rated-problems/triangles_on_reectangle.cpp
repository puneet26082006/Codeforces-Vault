...
void solve() {
    ...
    ll area1 = abs(x_down.back() - x_down.front()) * h ;
    ll area2 = abs(x_up.back() - x_up.front()) * h ;
    ll area3 = abs(y_right.back() - y_right.front()) * w ;
    ll area4 = abs(y_left.back() - y_left.front()) * w ;
